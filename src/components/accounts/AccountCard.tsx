...
import { useGetAccountBalanceByAccount, useCreateAccountBalance } from '@/lib/HTTP/account-balance'
...
export function AccountCard({ acc, banks, onEdit, onDelete }: AccountCardProps) {
