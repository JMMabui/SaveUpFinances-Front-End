...
// Generated on: 2026-01-23T14:39:09.629Z
import { z } from 'zod'

export const NotificationsPutNotificationsByIdReadBodySchema = z.object({
  isRead: z.boolean(),
})
export type NotificationsPutNotificationsByIdReadBody = z.infer<
  typeof NotificationsPutNotificationsByIdReadBodySchema
>
...
export type NotificationsPutNotificationsPreferencesBody = z.infer<
  typeof NotificationsPutNotificationsPreferencesBodySchema
>
